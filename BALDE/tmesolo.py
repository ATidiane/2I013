...
team2= SoccerTeam("T1",[Player("1",passe_equipier) ,Player("2",passe_equipier)])
team4= SoccerTeam("T1",[Player("1", passe_team4),Player("2",passe_team4),Player("3",passe_team4),Player("4",passe_team4)])
team1 = SoccerTeam("T2",[Player("1", fonceur_shooteur)])
team3 = SoccerTeam("T2",[Player("1", fonceur_shooteur),Player("2", fonceur_shooteur), Player("3",fonceur_shooteur)])
